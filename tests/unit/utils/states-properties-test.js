...
module('Unit | Utility | getState', function() {
...
module('Unit | Utility | getStatesForCountry', function() {
...
module('Unit | Utility | isCustomsDeclarationRequiredInUS', function() {
...
module('Unit | Utility | countryContainsState', function() {
